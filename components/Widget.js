...
const Widget = ({ newsResults, randomUserResult }) => {
        ...
        <div className="xl:w-[600px] hidden lg:inline ml-8 space-y-5">
            <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50">
                <div className="flex items-center p-3 rounded-full bg-red-300 relative">
                    ...
                    <input className="absolute inset-0 rounded-full pl-11 border-gray-500 text-gray-700 fous:shadow-lg focus:bg-white bg-gray-100" type="text" placeholder="Search Twitter" />
                </div>
            </div>
            ...
            <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:-w-[75%]">
                ...
                <AnimatePresence>
                    {newsResults.slice(0, articleNum).map((article) => (
                        <motion.div key={article.tile} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} transition={{ duration: 1 }}>
            ...
            <div className="sticky text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:-w-[75%]">
